...
class C : O.B() {
    ...
    val e: <!DEPRECATED_VISIBILITY!>FromCompanionA<!>? = null
    val f: <!DEPRECATED_VISIBILITY!>FromCompanionB<!>? = null
    ...
    val k: <!DEPRECATED_VISIBILITY!>FromAlpha<!>? = null
    val l: <!DEPRECATED_VISIBILITY!>FromBeta<!>? = null
    val m: <!DEPRECATED_VISIBILITY!>FromGamma<!>? = null
    ...
    val r: <!DEPRECATED_VISIBILITY!>FromDelta<!>? = null
}