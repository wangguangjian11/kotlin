...
public abstract class CLICompiler<A extends CommonCompilerArguments> extends CLITool<A> {
    ...
    private static AtomicBoolean kotlinHomeEnvVarIsSet = new AtomicBoolean(false);
    private static String kotlinHomeEnvVar = null;
    ...
    private static KotlinPaths computeKotlinPaths(@NotNull MessageCollector messageCollector, @NotNull CommonCompilerArguments arguments) {
        ...
        if (kotlinHomeEnvVarIsSet.compareAndSet(false, true)) {
            kotlinHomeEnvVar = System.getenv(KOTLIN_HOME_ENV_VAR);
        }
        File kotlinHome =
