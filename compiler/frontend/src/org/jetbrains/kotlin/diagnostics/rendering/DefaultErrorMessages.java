...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(DEPRECATED_VISIBILITY, "Visibility of this type by short name is deprecated, and soon is going to be removed. Please, add explicit qualifier or import", NAME);
