...
internal class AddExplicitImportForDeprecatedVisibilityFix(val expression: KtSimpleNameExpression, private val targetFqName: FqName) : KotlinQuickFixAction<KtSimpleNameExpression>(expression) {
    ...
    object Factory : KotlinSingleIntentionActionFactory() {
        override fun createAction(diagnostic: Diagnostic): IntentionAction? {
            if (diagnostic.factory != Errors.DEPRECATED_VISIBILITY) return null
            val castedDiagnostic = Errors.DEPRECATED_VISIBILITY.cast(diagnostic)
